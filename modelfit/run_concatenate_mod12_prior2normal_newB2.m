...
[all_parameters_thomp_noveltybonus_MAP, part_num] = concatenate_all_params_mod12_prior2normal_newB2();
...
% Remove 329
todel = find(model_parameters(:,1)==329);
model_parameters(todel,:)=[];
part_num(todel,:)=[];


save('C:\Users\mdubois\Google Drive\UCL\writing\MF_dev\data_for_figs_2\model_parameters.mat', 'model_parameters');
save('C:\Users\mdubois\Google Drive\UCL\writing\MF_dev\data_for_figs_2\model_parameters_desc.mat', 'model_parameters_desc');
save('C:\Users\mdubois\Google Drive\UCL\writing\MF_dev\data_for_figs_2\part_num.mat', 'part_num');

% save('D:\writing\MF_dev\data_for_figs\model_parameters.mat', 'model_parameters');

% Save
folder_name='prior2normal_newB2\';
