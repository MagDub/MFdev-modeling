function fit_mod12_prior2normal_newB_2Q0(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
param_bounds_sgm0 = [10^-8,8];
param_bounds_Q0 = [1,10]; 
param_bounds_xi = [10^-8,1];  
param_bounds_eta = [0,10];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    algo = 'mod12_prior2normal_newB_2Q0';
    n_param = 3;
    ...
    settings.params.lb          = [param_bounds_sgm0(1) param_bounds_sgm0(1)  param_bounds_Q0(1) param_bounds_Q0(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_eta(1) param_bounds_eta(1)];    % lower bound
    settings.params.ub          = [param_bounds_sgm0(2) param_bounds_sgm0(2)  param_bounds_Q0(2) param_bounds_Q0(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_eta(2) param_bounds_eta(2)];    % upper bound
    ...
    modelfunLL = @(x) modelMF_S0fixed_eta_2sgm0_2Q0(x,settings.params.param_names,ID,settings,data,gameIDs);
    modelfun = @(x) modelMF_S0fixed_eta_thomp4param_MAP_2sgm0_2Q0(x,settings.params.param_names,ID,settings,data,gameIDs, prior);
