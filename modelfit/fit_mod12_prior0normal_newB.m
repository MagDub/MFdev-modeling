function fit_mod12_prior0normal_newB(ID)
...
%     else
        load('D:/MaggiesFarm/modeling_28_02/participant_data/priors/thompson_4params_Q0_sgm0_xi_eta_uni/empirical_prior.mat','prior') %from generate_empirical_priors.mend
%     end
