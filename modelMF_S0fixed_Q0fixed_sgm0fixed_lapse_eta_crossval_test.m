function [nLogL, mo, logL] = modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_eta_crossval_test(param_val,param_names,sID,settings,data,gameIDs, game_ini, game_fin)
...
%% initialise model
settings.task.N_games = 20;
settings.task.Ngames_per_hor = 10;
settings.task

mo = initialise_model_MF_S0fixed_Q0fixed_sgm0fixed_lapse_eta(settings);
