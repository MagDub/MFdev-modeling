...
function [] = plot_behaviour_numberofapplesofchosentree_g1(numel_n, IS_SH_mat, IS_LH_mat)
...
% SH
b1S= bar(x_ax(3),nanmean(N_apples_of_selected_tree_SH),'FaceColor',col.groupSH(1,:), 'FaceAlpha', 0.3, 'BarWidth',1); 
...
% first LH
b1Lf = bar(x_ax(6),nanmean(N_apples_of_selected_tree_LH),'FaceColor',col.groupLH(1,:), 'FaceAlpha', 0.3, 'BarWidth',1);
...
addpath('D:\writing\export_fig\')
export_fig([out_dir 'Fig_number_apples_chosentree_g1.tif'],'-nocrop','-r200')
