function [nLogL, mo, logL] = modelMF_S0fixed_sgm0fixed_lapse(param_val,param_names,sID,settings,data,gameIDs)
...
%% initialise model
mo = initialise_model_MF_S0fixed_sgm0fixed_lapse(settings);
