function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_Q0fixed_lapse_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
load('participant_data\priors\hybrid_5params\empirical_prior.mat'); %from generate_empirical_priors.m
param_names = {'gamma', 'gamma', 'tau', 'tau', 'xi', 'xi', 'sgm0', 'w_hyb', 'w_hyb'};
