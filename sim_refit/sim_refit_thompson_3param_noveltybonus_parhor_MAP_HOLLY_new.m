function sim_refit_thompson_3param_noveltybonus_parhor_MAP_HOLLY_new(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    sim_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/4perdim/');

    %% load parameter values
    tmp = load('/home/mdubois/data/simulation_data/thompson/parhor_MAP/4perdim/inp_params_thompson.mat');
    ...
    results_dir = strcat('/home/mdubois/data/simulation_data/thompson/parhor_MAP/4perdim/results/');
   
    % save
    save_sim(results_dir, ID, settings, data, gameIDs, para_vals, mo);

    %% prior
    load('/home/mdubois/data/MaggiesFarm/participant_data/priors/thompson_4params_xi_eta_uni/empirical_prior.mat'); % Different prior !
