function old_sim_refit_thompson_3param_noveltybonus(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    settings.funs.valuefun      = @mvnorm_Thompson_noveltybonus_test; 
    ...
    sim_dir = strcat('D:\MaggiesFarm\modeling_05_07_developmental\simulation_data\thompson\4params\', int2str(n_per_dim), 'perdim\');
