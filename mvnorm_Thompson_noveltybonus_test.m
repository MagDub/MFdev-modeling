...
function [mo] = mvnorm_Thompson_noveltybonus_test(mo,idx_hor,idx_g,t)
...
unshown_tree = mo.mat.unshown_tree{1};

if unshown_tree == 1 || unshown_tree == 2
    Q(2) = Q(2) + eta; 
elseif unshown_tree == 4
    Q(3) = Q(3) + eta; 
end
