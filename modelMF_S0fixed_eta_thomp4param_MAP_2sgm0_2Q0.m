function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp4param_MAP_2sgm0_2Q0(param_val,param_names,sID,settings,data,gameIDs, prior)
...
%% initialise model
mo = initialise_model_MF_S0fixed_eta_2sgm0_2Q0(settings);
...
%         disp([int2str(c) '_' int2str(g)])
        ...
        if g_idx < g 
            ...
            % compute model game
            [logL(c,g),mo] = model_game_MF_2sgm0_2Q0(mo,tmp_dat,c,g,settings.opts.TLT);
        end
    end
end
...
param_names = {'sgm0', 'sgm0', 'Q0', 'Q0', 'xi', 'xi', 'eta', 'eta'};
