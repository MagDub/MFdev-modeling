function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_thomp3param_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
load('participant_data\priors\thompson_3params\empirical_prior.mat'); %from generate_empirical_priors.m
param_names = {'sgm0','Q0','xi', 'xi'};
