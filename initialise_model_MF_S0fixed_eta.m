function mo = initialise_model_MF_S0fixed_eta(settings)
...
mo.params.sgm0          = nan(settings.task.N_games,1); % prior mean std (set up, so that learning can be implemented
...
%% set up functions
mo.funs.decfun          = settings.funs.decfun ;          
mo.funs.valuefun        = settings.funs.valuefun ;            
mo.funs.priorfun        = settings.funs.priorfun ;            
mo.funs.learningfun     = settings.funs.learningfun ;  
