function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp4param_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
if holly == 1
    load('\home\mdubois\data\participant_data\priors\thompson_4params_xi_eta_uni\empirical_prior.mat'); %from generate_empirical_priors.mend
else
    load('D:\MaggiesFarm\modeling_05_07_developmental\participant_data\priors\thompson_4params_xi_eta_uni\empirical_prior.mat'); %from generate_empirical_priors.mend
end

param_names = {'sgm0','Q0','xi', 'xi', 'eta', 'eta'};
