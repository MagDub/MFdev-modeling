...
% Age Squared SH
AgeSqu_beta_SH = [];
AgeSqu_beta_SH(:,end+1) = consist_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = eta_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = firstApp_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = highValue_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = pickedC_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = pickedD_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = sgm0_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = score_SH.lm_SH{IQ}.Coefficients.Estimate';
AgeSqu_beta_SH(:,end+1) = xi_SH.lm_SH{IQ}.Coefficients.Estimate';

% Age Squared LH
AgeSqu_beta_LH = [];
AgeSqu_beta_LH(:,end+1) = consist_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = eta_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = firstApp_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = highValue_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = pickedC_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = pickedD_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = sgm0_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = score_LH.lm_LH{IQ}.Coefficients.Estimate';
AgeSqu_beta_LH(:,end+1) = xi_LH.lm_LH{IQ}.Coefficients.Estimate';

% Age Squared diff
AgeSqu_beta_diff = [];
AgeSqu_beta_diff(:,end+1) = consist_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = eta_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = firstApp_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = highValue_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = pickedC_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = pickedD_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = sgm0_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = score_diff.lm_diff{IQ}.Coefficients.Estimate';
AgeSqu_beta_diff(:,end+1) = xi_diff.lm_diff{IQ}.Coefficients.Estimate';
