function HOLLY_cv_mod10_thompson_3param_2Hor(ID)
    ...
    for k = 1:Kf
        ...
        settings.params.lb          = [param_bounds_sgm0(1)  param_bounds_Q0(1)  param_bounds_xi(1) param_bounds_xi(1)];    % lower bound
        settings.params.ub          = [param_bounds_sgm0(2)  param_bounds_Q0(2)  param_bounds_xi(2) param_bounds_xi(2)];    % upper bound
