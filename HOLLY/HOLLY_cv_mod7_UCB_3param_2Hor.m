function HOLLY_cv_mod7_UCB_3param_2Hor(ID)
    ...
    for k = 1:Kf
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_crossval(x,settings.params.param_names,ID,settings,data_train,gameIDs_train, 1, trials_trained_on);   
