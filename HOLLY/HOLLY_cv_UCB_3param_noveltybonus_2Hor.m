function HOLLY_cv_UCB_3param_noveltybonus_2Hor(ID)
    ...
    for k = 1:Kf
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if holly == 1
                results_dir = strcat('/home/mdubois/data/dev_participant_data/',algo,'/',int2str(n_param), 'params_2Hor/results/');
            else
            ...
            settings.params.lb          = [param_bounds_gamma(1)   param_bounds_gamma(1) param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_eta(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2)   param_bounds_gamma(2) param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_eta(2)];    % upper bound
        ...
        [data,gameIDs] = aggregateData(ID,data_dir);
            ...
            modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_lapse_eta_crossval(x,settings.params.param_names,ID,settings,data_train,gameIDs_train, 1, trials_trained_on);   
