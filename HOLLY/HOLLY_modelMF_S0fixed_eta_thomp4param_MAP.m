function [nMAP, nLogL, mo, logL] = HOLLY_modelMF_S0fixed_eta_thomp4param_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
if holly == 1
    load('/home/mdubois/data/participant_data/priors/thompson_4params/empirical_prior.mat'); %from generate_empirical_priors.mend
else
    load('participant_data\priors\thompson_4params\empirical_prior.mat'); %from generate_empirical_priors.mend
end
