function [nMAP, nLogL, mo, logL] = HOLLY_modelMF_S0fixed_eta_thomp4param_MAP_sgm0_xi_eta_uni(param_val,param_names,sID,settings,data,gameIDs)
...
if holly == 1
    ...
    load('participant_data\priors\thompson_4params_sgm0_xi_eta_uni\empirical_prior.mat'); %from generate_empirical_priors.mend
end
