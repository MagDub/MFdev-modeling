function HOLLY_fit_thompson_3p_nov_2Hor_2nov_Q01_MAPxi_beta(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    algo = 'thompson_noveltybonus_2nov_MAP_xi_beta';
    n_param = 3;
    ...
    modelfun = @(x) HOLLY_modelMF_S0fixed_eta_thomp4param_MAP_xi_beta(x,settings.params.param_names,ID,settings,data,gameIDs);
