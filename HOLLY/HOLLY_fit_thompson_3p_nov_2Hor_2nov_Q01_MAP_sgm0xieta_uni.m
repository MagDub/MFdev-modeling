function HOLLY_fit_thompson_3p_nov_2Hor_2nov_Q01_MAP_sgm0xieta_uni(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    algo = 'thompson_noveltybonus_2nov_MAP_sgm0_xi_eta_uni';
    n_param = 3;
    ...
    modelfun = @(x) HOLLY_modelMF_S0fixed_eta_thomp4param_MAP_sgm0_xi_eta_uni(x,settings.params.param_names,ID,settings,data,gameIDs);
