function HOLLY_fit_thompson_3param_noveltybonus_2Hor_2nov_Q01_MAP(ID)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    modelfun = @(x) HOLLY_modelMF_S0fixed_eta_thomp4param_MAP(x,settings.params.param_names,ID,settings,data,gameIDs);
