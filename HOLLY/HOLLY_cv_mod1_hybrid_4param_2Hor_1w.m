function HOLLY_cv_mod1_hybrid_4param_2Hor_1w(ID)
    ...
    for k = 1:Kf
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.param_names = {'gamma'  ''  'tau' '' 'sgm0' 'w_hyb'};   % is same param name as prev, write ''
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_gamma(1)  param_bounds_tau(1) param_bounds_tau(1) param_bounds_sgm0(1)  param_bounds_w_hyb(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2)  param_bounds_tau(2) param_bounds_tau(2) param_bounds_sgm0(2)  param_bounds_w_hyb(2)];    % upper bound
            ...
            modelfun = @(x) modelMF_S0fixed_Q0fixed_crossval(x,settings.params.param_names,ID,settings,data_train,gameIDs_train, 1, trials_trained_on);   
