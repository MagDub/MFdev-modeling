function mo = initialise_model_MF_S0fixed_Q0fixed_sgm0fixed_lapse(settings)
...
mo.params.sgm0          = 1.4*ones(settings.task.N_games,1); % prior mean std (set up, so that learning can be implemented
