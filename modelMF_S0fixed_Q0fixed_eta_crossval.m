function [nLogL, mo, logL] = modelMF_S0fixed_Q0fixed_eta_crossval(param_val,param_names,sID,settings,data,gameIDs, game_ini, game_fin)
...
%% initialise model
mo = initialise_model_MF_S0fixed_Q0fixed_eta(settings);
