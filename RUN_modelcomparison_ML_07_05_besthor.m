...
n=n+1;
mod(n).desc  = 'UCB2params2Hor';
mod(n).fname = strcat('UCB\2params_2Hor\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB2paramsnoveltybonus2Hor';
mod(n).fname = strcat('UCB_noveltybonus\3params_2Hor\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB3params2Hor';
mod(n).fname = strcat('UCB\3params_2Hor\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB3paramsnoveltybonus2Hor';
mod(n).fname = strcat('UCB_noveltybonus\4params_2Hor\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB3paramsnoveltybonus2Hor1Tau';
mod(n).fname = strcat('UCB_noveltybonus\4params_2Hor_excepttau\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB3paramsnoveltybonus2Hor1Xi';
mod(n).fname = strcat('UCB_noveltybonus\4params_2Hor_exceptxi\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'UCB3paramsnoveltybonus2Hor1Xi1Tau';
mod(n).fname = strcat('UCB_noveltybonus\4params_2Hor_exceptxitau\results\fmincon\res_UCB_');

n=n+1;
mod(n).desc  = 'hybrid3params2Hor';
mod(n).fname = strcat('hybrid\3params_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsnoveltybonus2Hor';
mod(n).fname = strcat('hybrid_noveltybonus\3params_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxi2Hor';
mod(n).fname = strcat('hybrid\3params_xi_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor1Tau';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor1Tau\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor1Xi';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor1Xi\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor1whyb';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor1whyb\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor1Tau1Xi';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor1Tau1Xi\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid3paramsxinoveltybonus2Hor1Tau1Xi1whyb';
mod(n).fname = strcat('hybrid_noveltybonus\3params_xi_2Hor1Tau1Xi1whyb\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid4params2Hor';
mod(n).fname = strcat('hybrid\4params_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid4paramsnoveltybonus2Hor';
mod(n).fname = strcat('hybrid_noveltybonus\4params_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid4paramsxi2Hor';
mod(n).fname = strcat('hybrid\5params_2Hor\results\fmincon\res_hybrid_');

n=n+1;
mod(n).desc  = 'hybrid4paramsxinoveltybonus2Hor';
mod(n).fname = strcat('hybrid_noveltybonus\5params_2Hor\results\fmincon\res_hybrid_');
...
bar([ nansum(lme(1,:)/sum(~isnan(lme(1,:))))  nansum(lme(2,:)/sum(~isnan(lme(2,:)))) nansum(lme(3,:)/sum(~isnan(lme(3,:))))   nansum(lme(4,:)/sum(~isnan(lme(4,:))))  nansum(lme(5,:)/sum(~isnan(lme(5,:)))) nansum(lme(6,:)/sum(~isnan(lme(6,:)))) nansum(lme(7,:)/sum(~isnan(lme(7,:)))) nansum(lme(8,:)/sum(~isnan(lme(8,:)))) nansum(lme(9,:)/sum(~isnan(lme(9,:)))) nansum(lme(10,:)/sum(~isnan(lme(10,:)))) nansum(lme(11,:)/sum(~isnan(lme(11,:)))) nansum(lme(12,:)/sum(~isnan(lme(12,:)))) nansum(lme(13,:)/sum(~isnan(lme(13,:)))) nansum(lme(14,:)/sum(~isnan(lme(14,:)))) nansum(lme(15,:)/sum(~isnan(lme(15,:)))) nansum(lme(16,:)/sum(~isnan(lme(16,:)))) nansum(lme(17,:)/sum(~isnan(lme(17,:)))) nansum(lme(18,:)/sum(~isnan(lme(18,:)))) nansum(lme(19,:)/sum(~isnan(lme(19,:)))) nansum(lme(20,:)/sum(~isnan(lme(20,:)))) nansum(lme(21,:)/sum(~isnan(lme(21,:)))) nansum(lme(22,:)/sum(~isnan(lme(22,:))))]) %some are nan, so we calculate the mean per participant (excluding nans)
%bar(nansum(lme,2))
% h = findobj(gca,'Type','patch');
h = findobj(gca,'Type','BAR');
set(h(1),'FaceColor',CT(:),'EdgeColor','k');
