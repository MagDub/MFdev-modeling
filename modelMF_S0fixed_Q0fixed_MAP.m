function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_Q0fixed_MAP(param_val,param_names,sID,settings,data,gameIDs)
...
%% initialise model
mo = initialise_model_MF_S0fixed_Q0fixed(settings);
...
load('participant_data\priors\hybrid_4params\empirical_prior.mat'); %from generate_empirical_priors.m
param_names = {'gamma', 'gamma', 'tau', 'tau', 'sgm0', 'w_hyb','w_hyb'};
