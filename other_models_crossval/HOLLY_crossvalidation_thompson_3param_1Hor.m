function HOLLY_crossvalidation_thompson_3param_1Hor(ID, optim_algo)
    ...
    for k = 1:10
        ...
        modelfun = @(x) modelMF_S0fixed_crossval(x,settings.params.param_names,ID,settings,data_train,gameIDs_train, 1, 180);  
        ...
        [test_nLogL, ~, ~] = modelMF_S0fixed_crossval(mEparams,settings.params.param_names,ID,settings,data_test,gameIDs_test, 1, 20);
