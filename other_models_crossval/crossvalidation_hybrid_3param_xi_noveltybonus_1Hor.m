function crossvalidation_hybrid_3param_xi_noveltybonus_1Hor(ID)
...
tic
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_xi_1Hor\results\');
            ...
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_tau(1) param_bounds_xi(1)  param_bounds_eta(1) param_bounds_w_hyb(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_eta(2) param_bounds_w_hyb(2)];    % upper bound
