function HOLLY_crossvalidation_hybrid_3param_noveltybonus_2Hor_1w(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.param_names = {'gamma'  ''  'tau' '' 'eta' 'w_hyb'};   % is same param name as prev, write ''
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_gamma(1)  param_bounds_tau(1) param_bounds_tau(1)  param_bounds_eta(1)  param_bounds_w_hyb(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2)  param_bounds_tau(2) param_bounds_tau(2)  param_bounds_eta(2)  param_bounds_w_hyb(2)];    % upper bound
            ...
            modelfun = @(x) modelMF_S0fixed_Q0fixed_sgm0fixed_eta_crossval(x,settings.params.param_names,ID,settings,data_train,gameIDs_train, 1, 180);   
