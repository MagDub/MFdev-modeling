function HOLLY_crossvalidation_hybrid_4param_xi_2Hor_1tau1w(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_gamma(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_sgm0(1)  param_bounds_w_hyb(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_sgm0(2)  param_bounds_w_hyb(2)];    % upper bound
