function crossvalidation_UCB_3param_noveltybonus_xi1Hor_Tau1Hor(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_xi1Hor_tau1Hor\results\');
