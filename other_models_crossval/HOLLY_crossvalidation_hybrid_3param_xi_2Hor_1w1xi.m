function HOLLY_crossvalidation_hybrid_3param_xi_2Hor_1w1xi(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_gamma(1)  param_bounds_tau(1) param_bounds_tau(1) param_bounds_xi(1) param_bounds_w_hyb(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2) param_bounds_tau(2)  param_bounds_tau(2) param_bounds_xi(2) param_bounds_w_hyb(2)];    % upper bound
