function HOLLY_crossvalidation_thompson_2param_noveltybonus_1Hor(ID)
    ...
    for k = 1:10
        ...
        settings.params.lb          = [param_bounds_sgm0(1)  param_bounds_Q0(1) param_bounds_eta(1)];    % lower bound
        settings.params.ub          = [param_bounds_sgm0(2)  param_bounds_Q0(2) param_bounds_eta(2)];    % upper bound
