function HOLLY_crossvalidation_UCB_2param_2Hor_1tau(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.lb          = [param_bounds_gamma(1) param_bounds_gamma(1)  param_bounds_tau(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2)  param_bounds_tau(2)];    % upper bound
