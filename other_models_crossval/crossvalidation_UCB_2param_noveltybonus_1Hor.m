function crossvalidation_UCB_2param_noveltybonus_1Hor(ID)
...
tic
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.lb          = [param_bounds_gamma(1)   param_bounds_tau(1) param_bounds_eta(1)];    % lower bound
            settings.params.ub          = [param_bounds_gamma(2)   param_bounds_tau(2) param_bounds_eta(2)];    % upper bound
