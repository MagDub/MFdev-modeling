function crossvalidation_hybrid_4param_xi_noveltybonus_2Hor(ID)
    ...
    for k = 1:10
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            settings.params.ub          = [param_bounds_gamma(2) param_bounds_gamma(2) param_bounds_tau(2) param_bounds_tau(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_sgm0(2)  param_bounds_eta(1)  param_bounds_w_hyb(2) param_bounds_w_hyb(2)];    % upper bound
