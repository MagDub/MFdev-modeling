function HOLLY_crossvalidation_thompson_3param_nov_2Hor_2nov_Q03(ID)
    ...
    for k = 1:10
        ...
        if holly == 1
            results_dir = strcat('/home/mdubois/data/participant_data/',algo,'/',int2str(n_param), 'params_2Hor_Q03/results/');
        else
            results_dir = strcat('D:\MaggiesFarm\modeling_28_02\participant_data\',algo,'\', int2str(n_param), 'params_2Hor_Q03\results\');
        end
